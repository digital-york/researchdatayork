class DepositsController < ApplicationController
  ...
  def index
    ...
    if browse_params[:refresh] == 'true'
      c = Puree::Collection.new(resource_type: :dataset)
      quantity = 10
      unless browse_params[:refresh_num].nil?
        quantity = browse_params[:refresh_num]
      end
  ...
  private
    ...
    def deposit_params
      params.require(:deposit).permit(:uuid,:file,:title,:people,:refresh,:refresh_num)
    end
end
