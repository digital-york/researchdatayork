  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved upload as @upload" do
        post :create, {:upload => invalid_attributes}, valid_session
        expect(assigns(:upload)).to be_a_new(Upload)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested upload" do
        upload = Upload.create! valid_attributes
        put :update, {:id => upload.to_param, :upload => new_attributes}, valid_session
        upload.reload
    ...
    context "with invalid params" do
      it "assigns the upload as @upload" do
        upload = Upload.create! valid_attributes
        put :update, {:id => upload.to_param, :upload => invalid_attributes}, valid_session
        expect(assigns(:upload)).to eq(upload)
      end
